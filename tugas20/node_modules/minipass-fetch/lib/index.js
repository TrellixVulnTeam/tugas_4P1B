...
const Body = require('mime-db/minipass-fetch/lib/body.js')
const { writeToStream, getTotalBytes } = Body
const Response = require('mime-db/minipass-fetch/lib/response.js')
const Headers = require('mime-db/minipass-fetch/lib/headers.js')
const { createHeadersLenient } = Headers
const Request = require('mime-db/minipass-fetch/lib/request.js')
const { getNodeRequestOptions } = Request
const FetchError = require('mime-db/minipass-fetch/lib/fetch-error.js')
const AbortError = require('mime-db/minipass-fetch/lib/abort-error.js')
