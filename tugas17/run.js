...
import MesinHitung, {Pi} from "./tugas17.js";
...
mh.x = 7;
mh.akar().kali(Pi).result();// luas lingkaran dengan jari jari 7 => Pi * r pangkat 2 = 154
mh.x = 4;
mh.exponen(3).result();// 4 pangkat 3 = 64
mh.akarRoot().result();// akar pangkat 2 dari 64 = 8